...
class ExcelEntryAppUslugiIP:
    def __init__(self, root, go_back=None):
        ...
        # self.root.title("Договор оказания услуг (ИП)") 
        ...
        self.root.bind_all("<Key>", copy_paste_fix)

    def go_back(self):
        self.root.pack_forget() if hasattr(self.root, "pack_forget") else self.root.destroy()
    ...
    def save_and_generate_word(self):
        ...
        if os.path.exists(self.word_template):
            ...
            word_output = self.excel_file.replace(".xlsx", "_услуги_документ.docx")
